...
<body>
	...
	<form action="../bdd/ecriture_bdd.php" method="post" id="lafitte Vigordane">
			<!-- champ cacher contenat le nom du club-->
	<input name="nom_club" type="hidden" value="Les archers Lafittois (Lafitte Vigordane)">
	<h3>- Jeunes -</h3>
		<div id="jeune">		
	 	<div class="cath">
