...
<body>
	<h2>Arc club Pechbonnieu</h2>
		<hr>
	<h3>Choisir dans les listes ou ajouter un nouvel archer dans le champ "ajouter archer"</h3>
	<form action="../bdd/ecriture_bdd.php" method="post" id="pechbo">
			<!-- champ cacher contenat le nom du club-->
	<input name="nom_club" type="hidden" value="Arc club de Pechbonnieu">
	<h3>- Jeunes -</h3>
		<div id="jeune">
		<div class="cath">
