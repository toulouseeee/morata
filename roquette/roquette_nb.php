...
<head>
<meta charset="utf-8">
<title>roquettes nombre inscription</title>
<link href="../styles/morata.css" rel="stylesheet" type="text/css">
</head>

<body>
	<h2>Les Archers de la Garonne (Roquettes)</h2>
	<form action="roquette_nb.php" method="post">
	...
	//ecriture du début du formulaire avec la cible spécifique au club
		echo(
	'<form action="roquette.php" method="post">
