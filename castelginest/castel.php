...
<body>
	<h2>Les Compagnons de l'arc (Castelginest)</h2>
		<hr>
	<h3>Choisir dans les listes ou ajouter un nouvel archer dans le champ "ajouter archer"</h3>
	<form action="../bdd/ecriture_bdd.php" method="post" id="castelginest">
		<!-- champ cacher contenat le nom du club-->
	<input name="nom_club" type="hidden" value="Compagnon de l arc (Castelginest)">
	<h3>- Jeunes -</h3>
		<div id="jeune">		
	 	<div class="cath">
