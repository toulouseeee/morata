<?php
		// création du formulaire de saisie pour la catégorie 10_an
		
		// récupere le nombre d'inscrit de la catégorie dans un champ caché(hidden) et l'affiche pour vérification
        echo('<p><input name="nb_10an" type="hidden" value="'.$nb_10an.'">Nombre d\'inscriptions : '.$nb_10an.'</p>');
		//boucle pour créer le nombre de champs 'liste' de formulaire pour les incris de la catégorie '10_an'
		for($i=1;$i<=$nb_10an;$i++){
		...
		<?php
		// création du formulaire de saisie pour la catégorie 13_an
		...
		<div class="cath">
	  	<h3>Arc nu (18m)</h3>
		<?php
		// création du formulaire de saisie pour la catégorie arc_nu
	  ...
	  <h3>Confirmé (30m)</h3>
		<?php
		// création du formulaire de saisie pour la catégorie confirmé
	  ...
	  <h3>Super confirmé (50m)</h3>
		<?php
		// création du formulaire de saisie pour la catégorie super confirmé
	  ...
	  <h3>Ultra confirmé (70m)</h3>
		...
		// récupere le nombre d'inscrit de la catégorie dans un champ caché(hidden) pour transmition et l'affiche pour vérification
